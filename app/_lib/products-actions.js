...
export async function createNewProject(formData) {
  try {
    ...
    const homepage_preview_video_url = formData.get("homepage_preview_video_url");
    ...
    const project = {
      ...
      homepage_preview_video: homepage_preview_video_url || null,
